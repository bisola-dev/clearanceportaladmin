...
$remarkText = "incomplete payment of school fees";
...
// Fetch existing disqualified students for incomplete payment
...
if (!empty($existingData)) {
    $successMessage = "Found " . count($existingData) . " existing disqualified records for incomplete payment.";
}
...
<head>
    ...
    <title>Bursary - Incomplete Payment Disqualified Students</title>
...
<body>
    ...
    <div class="container">
        <h1><?php echo htmlspecialchars($sectionName); ?> - Upload Disqualified Students (Incomplete Payment)</h1>
        <div class="welcome">
        ...
        <div class="upload-form">
            ...
            <p style="text-align: center; margin-bottom: 10px;">
                <a href="generate_disqualified_template.php?remark=incomplete_payment" class="btn btn-success" style="margin-right: 10px;">Download Excel Template</a>
        ...
        <?php if (!empty($existingData)): ?>
            <h3 style="text-align: center; color: #006400; margin-bottom: 20px;">Existing Disqualified Students (Incomplete Payment)</h3>
